...
// 핀 정의
// LCD 터치 관련 핀
#define TOUCH_CS 27    // 터치 컨트롤러 CS 핀
#define TOUCH_IRQ 34   // 터치 인터럽트 핀 (GPIO34로 변경, 입력 전용 핀)

// I2S 오디오 핀 (PCM5102 블루투스 오디오 출력용)
#define I2S_SCK 32    // I2S System Clock (SCK) - PCM5102
#define I2S_BCK 33    // I2S Bit Clock (BCK) - PCM5102
#define I2S_DIN 18    // I2S Data In (DIN) - PCM5102
#define I2S_LRCK 19   // I2S Left-Right Clock (LRCK) - PCM5102
